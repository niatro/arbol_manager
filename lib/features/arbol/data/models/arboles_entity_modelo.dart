...
//      {List<ArbolEntityModelo> listaArbolEntityModelo}) {
//    // variable de salida
//
//    List<Map<String, dynamic>> _listaMaps = List<Map<String, dynamic>>();
//    for (ArbolEntityModelo arbol in listaArbolEntityModelo) {
//      _listaMaps.add(arbol.toJson());
//    }
//
////    _listaMaps = listArboles.map((i) => ArbolEntityModelo.toJson(i)).toList();
//    return _listaMaps;
//  }
